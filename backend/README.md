...
## Project Structure
    ...
    ├── testdatamodel_dev_25759  # Django project configurations
...
1. Clone this repo and `cd testdatamodel_dev_25759`
...
2. Clone this repo and `cd testdatamodel_dev_25759`
